// This example demonstrates how to configure and use the EMAC peripheral.
...
void init_eth()
{
  Serial.println("ETHERNET TEST (once link ok, try ping 192.168.1.2)\nPress any key to stop");
  // reset phy off
  ...
  // init mac & phy layers
  Serial.println("Init MAC PHY drivers");
  init_mac();
  netjob=1;
