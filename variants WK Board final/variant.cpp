/*
  Copyright (c) 2017 WITTY KNOWLEDGE.  All right reserved.
  Compatible Arduino variant.cpp
  Designed for WK Agent Board (made in China)
*/
 ...
 *  18       TXD1  |  PA11  | TXD0 
 *  19       RXD1  |  PA10  | RXD0 
 *  20       SDA   |  PB12  | ANA9 - MOTOR OUT1
 *  21       SCL   |  PB13  | ANA10 - MOTOR OUT2
 ...
 *  45             |  PC18  | PWM4 (diag compatible SPI CAN2-INT)
 ...
 *  50             |  PC13  | TOR DIAG5
 *  51             |  PC12  | TOR DIAG4
 *  52       NPCS2 |  PB21  | ANA12 - MOTOR OUT2 (arduino compatible AD14, SPI-CS2, RXD2)
 *  53       CANTX1|  PB14  | CANTX1
 *  54       A0    |  PA16  | ANA1 (arduino compatible A0)
 *  55       A1    |  PA24  | - MCDA3
 *  56       A2    |  PA23  | - MCDA2
 *  57       A3    |  PA22  | - MCDA1
 *  58       TIOB2 |  PA6   | ANA5 (arduino compatible A4)
 *  59             |  PA4   | ANA6 (arduino compatible A5)
 *  60       TIOB1 |  PA3   | ANA11  - MOTOR OUT1 (arduino compatible A6, diag compatible LED2)
 ...
 *  64             |  PB19  | ANA3 (arduino compatible A10)
 *  65             |  PB20  | ANA4 (arduino compatible A11)
...
extern const PinDescription g_APinDescription[]=
{
  ...
  { PIOC, PIO_PC28B_TIOA7,   ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL, NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER     }, // ENABLE2
  { NULL, 0, 0, PIO_NOT_A_PIN, PIO_DEFAULT, 0, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER },
  { NULL, 0, 0, PIO_NOT_A_PIN, PIO_DEFAULT, 0, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER },
  // 6 
  { PIOC, PIO_PC24B_PWML7,   ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),   NO_ADC, NO_ADC, PWM_CH7,     NOT_ON_TIMER },
  ...
  { PIOC, PIO_PC22B_PWML5,   ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),   NO_ADC, NO_ADC, PWM_CH5,     NOT_ON_TIMER }, // ENABLE1
  ...
  // 20/21 - ANA9 - ANA10
  { PIOB, PIO_PB12X1_AD8,    ID_PIOB, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC10,   ADC8, NOT_ON_PWM,  NOT_ON_TIMER }, // TWD1 - SDA0
  { PIOB, PIO_PB13X1_AD9,   ID_PIOB, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC11,   ADC9, NOT_ON_PWM,  NOT_ON_TIMER }, // TWCK1 - SCL0

  // 22
  { PIOB, PIO_PB26,    ID_PIOB, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 22
  ...
  // 25/28 Memory eMMC - PIO_PERIPH_B 
  { PIOD, PIO_PD0B_MCDA4,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 25
  { PIOD, PIO_PD1B_MCDA5,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 26
  { PIOD, PIO_PD2B_MCDA6,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 27
  { PIOD, PIO_PD3B_MCDA7,     ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 28
  ...
  { PIOC, PIO_PC18B_PWMH6,          ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),                NO_ADC, NO_ADC, PWM_CH6,  NOT_ON_TIMER }, // PIN 45
  ...
  { PIOB, PIO_PB21X1_AD14,   ID_PIOB, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_ANALOG,                      ADC9,   ADC14, NOT_ON_PWM,  NOT_ON_TIMER },  // PIN 52 
  ...
  { PIOA, PIO_PA3X1_AD1,     ID_PIOA, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC8,   ADC1,   NOT_ON_PWM,  TC0_CHB1     }, // AD6
  { PIOA, PIO_PA2X1_AD0,     ID_PIOA, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC6,   ADC0,   NOT_ON_PWM,  TC0_CHA1     }, // AD7
  // 62
  { PIOB, PIO_PB17X1_AD10,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC7,   ADC10,  NOT_ON_PWM,  NOT_ON_TIMER }, // AD8
  { PIOB, PIO_PB18X1_AD11,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC1,   ADC11,  NOT_ON_PWM,  NOT_ON_TIMER }, // AD9
  { PIOB, PIO_PB19X1_AD12,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC2,  ADC12,  NOT_ON_PWM,  NOT_ON_TIMER }, // AD10
  { PIOB, PIO_PB20X1_AD13,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC3,  ADC13,  NOT_ON_PWM,  NOT_ON_TIMER }, // AD11  
  // 66/67 - DAC0/DAC1
  ...
  // 79 - 80
  { PIOB, PIO_PB19,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC2,  ADC12,    NOT_ON_PWM,  NOT_ON_TIMER }, // ANA3
  { PIOB, PIO_PB20,   ID_PIOB, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC3,  ADC13,    NOT_ON_PWM,  NOT_ON_TIMER }, // ANA4
  ...
  { NULL, 0, 0, PIO_NOT_A_PIN, PIO_DEFAULT, 0, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER },
  // 100 = TOR_DIAG1
  { PIOC, PIO_PC10, ID_PIOC, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_DIGITAL, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // PIN 100
  ...
  // 108 - PWM2 (DRIVER)
  { PIOC, PIO_PC20B_PWMH4, ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), NO_ADC, NO_ADC, PWM_CH4, NOT_ON_TIMER }, // 108
  ...
  // 126 .. 128
  { PIOB, PIO_PB21X1_AD14,   ID_PIOB, PIO_INPUT, PIO_DEFAULT, PIN_ATTR_ANALOG, ADC9,  ADC14,  NOT_ON_PWM,  NOT_ON_TIMER },  // ANA10 PIN 126 - PB21 with enabled ADC  
...
uint8_t g_pinStatus[PINS_COUNT] = {0}; // version arduino 1.8.x
